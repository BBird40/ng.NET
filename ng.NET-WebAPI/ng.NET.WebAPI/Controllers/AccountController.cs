...
using ng.NET.WebAPI.App_Start;
using ng.NET.WebAPI.Models.AccountBinding;
using ng.NET.WebAPI.Models.AccountView;
using ng.NET.WebAPI.Models.Identity;
using ng.NET.WebAPI.Providers;
using ng.NET.WebAPI.Results;
...
namespace ng.NET.WebAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("ManageInfo")]
        public async Task<ManageInfo> GetManageInfo(string returnUrl, bool generateState = false)
        {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.CreateAsync(new ApplicationUser() { UserName = model.Email, Email = model.Email },
                model.Password);           
            return !result.Succeeded ? GetErrorResult(result) : Ok();
        }
